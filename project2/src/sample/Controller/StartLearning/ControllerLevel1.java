...
public class ControllerLevel1 implements Initializable {
    ...
    //Bắt sự kiện khi ấn vào gợi ý 1
    @FXML
    public void on1(ActionEvent event) throws SQLException {
        ...
        if (tfCheck.getText().trim().isEmpty()) {  // Nếu người dùng không điền chữ cái nào thì phải báo cho họ biết
    ...
    //Bắt sự kiện khi ấn vào gợi ý 2
    @FXML
    ...
    //Bắt sự kiện khi ấn vào gợi ý 3
    @FXML
    ...
    //Bắt sự kiện khi ấn vào gợi ý 4
    @FXML
    public void on4(ActionEvent event) {
    ...
    //Bắt sự kiện khi ấn vào nút phát âm
    @FXML
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        //Set color TextArea
        ta.setStyle(
                "-fx-control-inner-background: lightpink;" //Xét màu background của textArea
        );
    }
